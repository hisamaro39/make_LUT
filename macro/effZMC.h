...
effZMC::effZMC(TTree *tree) : fChain(0) 
{
  ...
  const char* rec = "datalist/inputEfficiencyZTandPSampleAr7514.list";
...
Int_t effZMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t effZMC::LoadTree(Long64_t entry)
{
...
void effZMC::Show(Long64_t entry)
{
...
Int_t effZMC::Cut(Long64_t entry)
{
