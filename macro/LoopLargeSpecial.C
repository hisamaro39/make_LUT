#include "fittingLargeSpecial.h"
#include "TFile.h"
#include "TH2.h"
#include "TString.h"
#include "TGraphErrors.h"
#include <fstream>
void LoopLargeSpecial(const int nbins, double* binlow, TString path, float xlow_fit, float xhigh_fit, TString inputfilename, TString outputtxtname, TString mode, TString histoname,int charge,int phi,int etabin ,int phibin){
