...
#ifndef validationT_h
#define validationT_h
...
#ifdef validationT_cxx
validationT::validationT(TTree *tree) : fChain(0) 
{
  TChain *chain = new TChain("validationT");
  //const char* rec = "datalist/inputValidationMakeLUTExt.list";
  //const char* rec = "datalist/inputValidationMakeLUTExtMCZmumu.list";
  const char* rec = "datalist/inputValidationMakeLUTSegment.list";
  //const char* rec = "datalist/inputValidationMakeLUTData16Segment.list";
...
Int_t validationT::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t validationT::LoadTree(Long64_t entry)
{
...
void validationT::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("ext_eta", &ext_eta, &b_ext_eta);
   fChain->SetBranchAddress("ext_phi", &ext_phi, &b_ext_phi);
...
void validationT::Show(Long64_t entry)
{
...
Int_t validationT::Cut(Long64_t entry)
{
