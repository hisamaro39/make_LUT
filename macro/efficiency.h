...
public :
   ...
   Bool_t          probe_passSA_1_new;
   Bool_t          probe_passSA_2_new;
   ...
   TBranch        *b_probe_passSA_1_new;   //!
   TBranch        *b_probe_passSA_2_new;   //!
...
efficiency::efficiency(TTree *tree) : fChain(0) 
{
  ...
  //const char* rec = "datalist/inputEfficiencyDefaultLUTNewDr.list";
  //const char* rec = "datalist/inputEfficiencyDefaultLUTNewDr2.list";
  //const char* rec = "datalist/inputEfficiencyNewLUTNewDr2.list";
  //const char* rec = "datalist/inputEfficiencyDefaultLUTPlusEE.list";
  //const char* rec = "datalist/inputEfficiencyDefaultLUTNewDr3.list";
  //const char* rec = "datalist/inputEfficiencyDefaultLUTNewDr4.list";
  //const char* rec = "datalist/inputEfficiencyNewLUTVersion1.list";
  //const char* rec = "datalist/inputEfficiencyDefaultLUTJpsi.list";
  //const char* rec = "datalist/inputEfficiencyNewLUTJpsi.list";
  //const char* rec = "datalist/inputEfficiencyNewLUTEENoSL2.list";
  //const char* rec = "datalist/inputEfficiencyCombineVersion3.list";
  //const char* rec = "datalist/inputEfficiencyCombineEESmallLarge.list";
  //const char* rec = "datalist/inputEfficiencyCombineEESmall.list";
  const char* rec = "datalist/inputEfficiencyCombineVersion4.list";
...
void efficiency::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("probe_passSA_1_new", &probe_passSA_1_new, &b_probe_passSA_1_new);
   fChain->SetBranchAddress("probe_passSA_2_new", &probe_passSA_2_new, &b_probe_passSA_2_new);
   Notify();
}
