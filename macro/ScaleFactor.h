...
public :
   ...
   virtual void     Loop(vector<string> list, string output);
...
#ifdef ScaleFactor_cxx
ScaleFactor::ScaleFactor(){}

ScaleFactor::~ScaleFactor(){}

Int_t ScaleFactor::GetEntry(Long64_t entry)
{
...
Long64_t ScaleFactor::LoadTree(Long64_t entry)
{
...
void ScaleFactor::Init(TTree *tree)
{
   // Set object pointer
   tag_trigger_chain = 0;
...
Bool_t ScaleFactor::Notify()
{
   return kTRUE;
}

void ScaleFactor::Show(Long64_t entry)
{
...
Int_t ScaleFactor::Cut(Long64_t entry)
{
